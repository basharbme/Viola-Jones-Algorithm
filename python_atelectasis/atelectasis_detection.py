...
atelectasis_cascade = cv2.CascadeClassifier('data/atelectasis-cascade.xml')

count = 1
files = []
res = {"neg-true": 0, "neg-false": 0, "pos-true": 0, "pos-false": 0}
for file in glob.iglob("/home/ebraiz/Documents/python_atelectasis/opencv_workspace/pos/*.jpg"):
    gray = imread(file)
...
for file in files:
    ...
    for (x,y,w,h) in atelectasis:
        ...
        cv2.putText(gray, 'Atelectasis', (20, 20), font, 0.5, (255,255,0), 2, cv2.LINE_AA)
